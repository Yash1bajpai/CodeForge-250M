...
print("=================================================================")
print("=== [1. VERIFYING CHUNK 12 (~250M TOKENS!) & CLEANING DISK] ===")
print("=================================================================")
...
print("\n=================================================================")
print("=== [2. RELEASING CHUNK 12 (~250M TOKENS!) TO HUGGING FACE] ===")
print("=== [THE QUARTER-BILLION TOKEN MILESTONE!] ===")
print("=================================================================")
...
print("\n=================================================================")
print("=== [3. CONFIGURING STAGE 13 / CHUNK 13 (TARGET -> STEP 67,000)] ===")
print("=== [TOWARDS 275 MILLION TOKENS!] ===")
print("=================================================================")
...
# Update target steps to 67000 (~275 Million tokens)
if "max_steps = " in content:
    content = content.replace("max_steps = 61000", "max_steps = 67000")
    content = content.replace("max_steps = 55000", "max_steps = 67000")
    content = content.replace("max_steps = 49000", "max_steps = 67000")

content = content.replace("STAGE 12 / CHUNK 12", "STAGE 13 / CHUNK 13")
content = content.replace("Chunk 12 completed", "Chunk 13 completed")
...
print("--> Successfully updated training/train.py for Stage 13 / Chunk 13!")
print("    - Resumes from: latest_checkpoint.pt (~Step 61,000 / ~250 Million Tokens!)")
print("    - Target Chunk Size: +6,000 steps (Will reach Step 67,000 / ~275 MILLION TOKENS!)")

print("\n=================================================================")
print("=== [4. LAUNCHING CHUNK 13 IN BACKGROUND (NOHUP)] ===")
print("=================================================================")
...
print("--> Launched Chunk 13 training process in background!")
...
if train_procs:
    print("SUCCESS: Stage 13 / Chunk 13 Training is LIVE and running on Tesla T4 GPU!")
