...
def train():
    ...
    print("\n=======================================================")
    print(f"=== [LAUNCHING CODEFORGE-250M STAGE 12 / CHUNK 12] ===")
    ...
    print("-" * 65)
    print(f"--> [STAGE 12 / CHUNK 12 COMPLETED] Processed {tokens_processed:,} tokens in {elapsed:.1f} seconds ({tps:.1f} tokens/sec)!")
    print("SUCCESS: Tesla T4 GPU Training Overnight Chunk 12 completed and saved!")
