...
print("=================================================================")
print("=== [1. RELEASING STAGE 7 (~130M TOKENS) TO HUGGING FACE] ===")
print("=================================================================")
...
print("\n=================================================================")
print("=== [2. CONFIGURING STAGE 8 / CHUNK 8 (TARGET -> STEP 37,500)] ===")
print("=================================================================")
...
# Update target steps to 37500 (~155 Million tokens)
if "max_steps = " in content:
    content = content.replace("max_steps = 31500", "max_steps = 37500")
    content = content.replace("max_steps = 25500", "max_steps = 37500")

content = content.replace("STAGE 7 / CHUNK 7", "STAGE 8 / CHUNK 8")
content = content.replace("Chunk 7 completed", "Chunk 8 completed")
...
print("--> Successfully updated training/train.py for Stage 8 / Chunk 8!")
print("    - Resumes from: latest_checkpoint.pt (~Step 31,400 / ~130 Million Tokens!)")
print("    - Target Chunk Size: +6,000 steps (Will reach Step ~37,400 / ~155 Million tokens!)")

print("\n=================================================================")
print("=== [3. LAUNCHING CHUNK 8 IN BACKGROUND (NOHUP)] ===")
print("=================================================================")
...
print("--> Launched Chunk 8 training process in background!")
...
if train_procs:
    print("SUCCESS: Stage 8 / Chunk 8 Training is LIVE and running on Tesla T4 GPU!")
